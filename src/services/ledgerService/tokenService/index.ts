...
export class TokenService extends LedgerSubService {
    ...
    calculateDistributionFee(tokenId: string, minimumQuantity: string) {
        return handleError(async () => {
            return this.context.ledger.asset.calculateDistributionFee({assetId: tokenId, minimumQuantity})
        })
    }
