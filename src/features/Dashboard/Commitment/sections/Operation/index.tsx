...
export const Operation = ({
  ...
  const accountHasNoCommittedFunds = !!(
    isOperationTypeRemove && !committedBalance
  );

  const canRemoveCommitmment =
  ...
  const canManageCommitment = isOperationTypeAdd || canRemoveCommitmment;
